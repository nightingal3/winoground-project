...
from .VLMOrder.perturbtextorder import nounadjshuf, nonnounadjshuf, trigramshuf, nounshuf, advshuf, adjshuf, verbshuf, randomshuf
...
def load_transforms(args):
    return make_train_transforms(distractor_type_text=args.distractor_text, distractor_type_image=args.distractor_image, is_winoground=args.train_dataset=="winoground"), val_transforms, val_transforms