...
class ContrastiveLoss(nn.Module):
    ...
    """
    def __init__(self, sim=cos_similarity, lamb1=0.4, lamb2=0.3, lamb3=0.3, lamb4=0.0, c=-0.1):
        ...
        self.lamb3 = lamb3
        self.lamb4 = lamb4
        self.lamb5 = (1 - lamb1 - lamb2 - lamb3 - lamb4)
        assert self.lamb5 >= 0
        self.c = c
    ...
    def forward(self, c0, i0, c1, i1):
        ...
        score = self.lamb1 * caption_sim - self.lamb2 * pair0_sim + self.lamb5 * text_distractor_sim + self.lamb4 * image_distractor_sim - self.lamb3 * pair1_sim + self.c
        zero = torch.tensor(0)
